...
- Textos âmbar sem variante dark explícita precisam ser clareados no `.dark`; os tints âmbar -50/-100/-200 remapeados para superfícies escuras tornam `text-amber-600..900` ilegível.
