...
function StatCardSkeleton() {
  return (
    <div className="animate-pulse chamfer-sm border border-border bg-card p-4">
      <div className="flex items-start justify-between">
