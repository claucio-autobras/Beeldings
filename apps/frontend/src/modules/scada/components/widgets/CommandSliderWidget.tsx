    ...
    return (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8 }}>
          <span data-scada-hover-text-surface="true" style={{ fontSize: 11, color: cardMuted, fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {widget.label}
          </span>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 6 }}>
        <span data-scada-hover-text-surface="true" style={{ fontSize: 11, color: '#94A3B8', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          {widget.label}
        </span>
        {widget.showValue && (
          <span data-scada-hover-text-surface="true" style={{ fontSize: 13, fontWeight: 600, color: accent, fontFamily: 'Roboto Mono, monospace', fontVariantNumeric: 'tabular-nums' }}>
