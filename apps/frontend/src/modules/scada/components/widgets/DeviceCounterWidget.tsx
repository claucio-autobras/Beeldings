...
import { getDeviceCounterIcon } from './scadaIcons';
...
function PointListPopup({
  ...
  const CounterIcon = getDeviceCounterIcon(widget.iconName);
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '12px 14px', borderBottom: '1px solid #1E293B' }}>
          {createElement(CounterIcon, { size: 16, color: widget.colorOn, strokeWidth: 2, style: { flexShrink: 0 } })}
    ...
    <>
      ...
      >
        ...
        <div style={{ minWidth: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', lineHeight: 1.15 }}>
          {widget.showLabel && (
            <span data-scada-hover-text-surface="true"
              style={{
