...
export function NumericDisplayWidgetView({ widget, getValue, colorOverride, textOverride, staticRender }: Props) {
  ...
  return (
    <div data-scada-hover-border-surface="true" style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0A0F1E', borderRadius: 6, border: '1px solid rgba(6,182,212,0.2)', userSelect: 'none', overflow: 'hidden' }}>
      <div data-scada-hover-text-surface="true" style={{ fontFamily: "'Fira Code', 'Courier New', monospace", fontSize, fontWeight: 700, color, letterSpacing: '0.08em', fontVariantNumeric: 'tabular-nums', textShadow: isOffline || isTransparentColor(widget.color) ? 'none' : `0 0 12px ${scadaColorWithAlpha(widget.color, '60')}`, lineHeight: 1 }}>
