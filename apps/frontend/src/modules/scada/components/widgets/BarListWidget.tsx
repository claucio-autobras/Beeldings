...
export function BarListWidgetView({ widget: w, getValue, staticRender }: Props) {
  const rows = w.rows;
  return (
    <div data-scada-hover-border-surface="true" data-scada-hover-content-surface="true" data-scada-hover-text-surface="true" style={{ ...dashCardStyle(w), padding: '12px 14px', gap: 10 }}>
