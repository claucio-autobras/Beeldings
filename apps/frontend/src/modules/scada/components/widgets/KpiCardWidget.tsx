...
export function KpiCardWidgetView({ widget: w, getValue, staticRender }: Props) {
  ...
  return (
    <div data-scada-hover-border-surface="true" data-scada-hover-content-surface="true" data-scada-hover-text-surface="true" style={{ ...dashCardStyle(w), padding: '12px 14px', justifyContent: 'space-between' }}>
