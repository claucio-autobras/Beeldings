...
export function TrafficLightWidgetView({ widget, getValue, staticRender }: Props) {
  ...
  return (
    <div data-scada-hover-border-surface="true" data-scada-hover-content-surface="true" style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-evenly', padding: 4, backgroundColor: '#0F172A', borderRadius: 8, border: '1px solid #1E293B', userSelect: 'none' }}>
      {[
