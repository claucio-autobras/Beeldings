      ...
      <span style={{ display: 'inline-flex', alignItems: 'center', gap: showLabel ? 5 : 0 }}>
        {phase === 'sending'
          ...
          : Icon
            ...
            : null}
        {showLabel && <span data-scada-hover-text-surface="true">{widget.label}</span>}
      </span>
      {widget.showState && !widget.iconOnly && (
        <span data-scada-hover-text-surface="true" style={{ fontSize: Math.max(9, widget.fontSize * 0.7), opacity: 0.85, fontWeight: 500, letterSpacing: 0.5 }}>
