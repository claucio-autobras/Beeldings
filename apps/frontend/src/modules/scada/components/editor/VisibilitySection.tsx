...
export function VisibilitySection({ widget, onChange, hideHeader = false }: Props) {
  ...
  return (
    <div className={hideHeader ? 'flex flex-col gap-2 px-4 pb-4 pt-3' : 'border-b border-slate-700/60 pb-4 pt-3'}>
      {!hideHeader && (
      ...
      <div className={hideHeader ? 'flex flex-col gap-2' : 'flex flex-col gap-2 px-4'}>
        {/* Mode */}
