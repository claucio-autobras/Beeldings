  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[280px_1fr]">
        {/* ── Tipos de relatório ──────────────────────────── */}
        <aside className="chamfer flex flex-col gap-1.5 border border-border bg-card p-2 lg:sticky lg:top-4 lg:self-start">
          {REPORT_TYPES.map((r) => {
        ...
        {/* ── Painel de geração ───────────────────────────── */}
        <section className="chamfer border border-border bg-card p-5">
