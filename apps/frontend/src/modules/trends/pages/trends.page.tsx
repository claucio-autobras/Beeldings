...
export default function TrendsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ── Filtros ──────────────────────────────────────── */}
      <div className="chamfer border border-border bg-card p-4">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[280px_1fr]">
        ...
        <aside className={`${showVarPanel ? 'flex' : 'hidden'} chamfer max-h-[60dvh] flex-col border border-border bg-card lg:sticky lg:top-4 lg:flex lg:max-h-[calc(100dvh-9rem)]`}>
