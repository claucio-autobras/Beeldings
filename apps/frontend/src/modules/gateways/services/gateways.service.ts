...
export interface GatewayHealthSummary {
  ...
  /** Percentual, quando uma versão futura do agente passar a reportá-lo. */
...
export interface GatewayItem {
  id: string;
  tenantId: string;
  /** Nome do cliente dono do gateway, presente no resumo do Dashboard. */
  tenantName?: string;
  /** Sites distintos atendidos pelo gateway, derivados de projetos e equipamentos. */
  siteNames?: string[];
  status: string;
