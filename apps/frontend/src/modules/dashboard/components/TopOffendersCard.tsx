    ...
    <div className="chamfer-sm border border-border bg-card shadow-sm">
      <div className="border-b border-border/60 p-4 pb-3">
        <h2 className="flex items-center gap-2 text-sm font-medium text-foreground">
           <Hex size="md" className="bg-orange-100 text-orange-600 dark:bg-orange-950/50 dark:text-orange-300">
        ...
        <div className="divide-y divide-border/60">
          {rows.map((o, i) => (
            <button
              ...
              className="group chamfer-clickable flex w-full items-center gap-3 p-3 text-left"
            ...
            >
              <span className="w-4 shrink-0 text-center text-xs font-semibold tabular-nums text-muted-foreground">
               ...
               <span className={`hex h-[9px] w-[8px] shrink-0 ${SEVERITY_DOT[o.severity]}`} />
