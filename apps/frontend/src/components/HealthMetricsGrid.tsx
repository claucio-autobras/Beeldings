  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {tiles.map((tile) => {
        ...
        const isStale = hasValue && tile.stale;
        return (
          <div
            key={tile.key}
            ...
            title={
              tile.unreliable
                ...
                : tile.emptyState === 'não suportado'
                  ...
                  : isStale
                    ? 'Último valor conhecido — o ciclo de coleta mais recente não trouxe uma leitura nova para este ponto.'
                    : tile.title
            }
          >
            ...
            <p
              className={[
                'mt-0.5 flex items-baseline gap-1 truncate text-sm font-semibold',
                tile.unreliable
            ...
            >
              ...
              {isStale && (
                <span className="shrink-0 rounded bg-muted px-1 py-px text-[9px] font-normal normal-case text-muted-foreground">
                  desatualizado
                </span>
              )}
            </p>
