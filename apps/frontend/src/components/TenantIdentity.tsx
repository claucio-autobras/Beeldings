...
export function TenantIdentity({ tenant, showLabel = true }: { tenant: TenantIdentityData; showLabel?: boolean }) {
  ...
  return (
    ...
    >
      {showLogo && (
        <div
          className="relative flex h-7 w-7 md:h-9 md:w-9 lg:h-10 lg:w-10 shrink-0 items-center justify-center overflow-hidden rounded-[4px] bg-white shadow-sm ring-1 ring-slate-200/80 dark:bg-white/95 dark:ring-white/10"
