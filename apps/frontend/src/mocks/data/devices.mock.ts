...
export interface BACnetPoint {
  ...
  siteMetric?: 'energy' | 'water' | 'runtime' | null;
  siteMetricMode?: 'cumulative' | 'rate' | 'state' | null;
  status: PointStatus;
  lastUpdate: string;
}
...
export const mockSites = [
  { id: 'site-001', name: 'Bloco A — Pavimento 3',  tenantId: 'tenant-autobras', location: 'Rua das Flores, 100 — Bloco A' },
  { id: 'site-002', name: 'Bloco B — Pavimento 1',  tenantId: 'tenant-autobras', location: 'Rua das Flores, 100 — Bloco B' },
  { id: 'site-003', name: 'Bloco A — Pavimento 1',  tenantId: 'tenant-autobras', location: null },
  { id: 'site-004', name: 'Bloco A — Subsolo',       tenantId: 'tenant-autobras', location: 'Rua das Flores, 100 — Subsolo' },
  { id: 'site-005', name: 'Área de Vendas — Térreo', tenantId: 'tenant-shopb', location: 'Avenida Central, 500 — Térreo' },
  { id: 'site-006', name: 'Casa de Máquinas — Cob.', tenantId: 'tenant-shopb', location: 'Avenida Central, 500 — Cobertura' },
  { id: 'site-007', name: 'Depósito — Subsolo',      tenantId: 'tenant-shopb', location: null },
];
