...
// In the browser, the Next app proxies `/api` to the backend. Keeping this
// same-origin default also makes asset URLs work in previews and production
// when NEXT_PUBLIC_API_URL is not injected at build time.
