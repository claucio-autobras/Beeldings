...
import { SensitiveActionGuard } from './presentation/guards/sensitive-action.guard.js';
...
export class AuthController {
  ...
  // com register/listUsers. A confirmação de senha impede exclusões acidentais.
  @Delete('users/:id')
